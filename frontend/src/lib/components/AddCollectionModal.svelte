  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-gray-900 rounded-lg p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto text-gray-100">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div class="space-y-6">
          <div>
            ...
            <p class="text-sm text-gray-400 mt-1">Public URL is: testimonial.to/{spaceName}</p>
          </div>
      ...
      <div class="mt-8 flex justify-end">
        ...
        <Button class="bg-indigo-600 text-white hover:bg-indigo-700">Create Collection</Button>
      </div>
    </div>
  </div>
{/if}
